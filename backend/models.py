...
class Chat(db.Model):
    ...
    system_prompt = db.Column(
        ...
        default=(
            ...
            "You are intelligent, precise, calm, helpful and "
            "technically capable. Give clear answers. "
...
class EmailOtp(db.Model):
    """
    Stores a single pending email verification OTP per user.
